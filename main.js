...
function fetchTodo(){
  ...
  .then(function(data){
      ...
      result.innerHTML = `<ul id="grocery" class="list-group list-group-flush">
      <li class="list-group-item" id="result" style="display: flex; justify-content: space-between;"> ${data.title}
        <button class="btn btn-danger me-md-2 delete" type="button">X</button>
      </li>
